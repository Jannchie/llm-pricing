...
| `peelRoutingTiers(model)` | A router id with its reasoning tiers peeled (`gpt-5-high` → `gpt-5`), the second pass a lookup makes when the literal prices nothing |
